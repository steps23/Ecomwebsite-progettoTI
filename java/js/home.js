...
const createSuggestions = (data_suggestion,data) => {
    ...
    for(let i=0;i<data.length; i++){
        //console.log(i);
        //console.log(item.id);
        //console.log(isPresent(data[i],data_suggestion));
...
const isPresent = (element,data) => {
    //console.log('datasugg in control');
    //console.log(data);
    //console.log(data.length);
    for (let i=0;i<data.length; i++){
        //console.log('control k: '+i);
        //console.log('itemid: '+data[i].id);
...
const removeDuplicates = (data,data_to_remove) => {
    ...
    for(let i=0;i<data.length; i++){ //check all the suggestion
        ...
        //console.log(!data_to_remove.includes(item));
