...
sizeBtns.forEach((item, i) =>{
    item.addEventListener('click', () => {
        ...
        if (cartBtn.textContent =='Added') //if i change size, text of the cart button changes
        {
            cartBtn.innerHTML = 'Add to cart';
        }
        const wishlistBtn = document.querySelector('.wishlist-btn');
        if (wishlistBtn.textContent =='Added') //if i change size, text of the wishlist button changes
        {
